...
def test_arm_overwrites_and_pids_are_isolated(tmp_path):
    ...
    assert f.read(1) == (CLOSE, None, "boot-A")
    assert f.read(2) == (RELAUNCH, "two", "boot-A")
